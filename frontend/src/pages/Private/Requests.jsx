      ...
      <div className="card">
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Submit and track maintenance requests</p>
          </div>
        </div>
        <p className="text-center text-gray-500 dark:text-gray-400 py-12">Request system coming soon...</p>
      </div>
    </div>
  )
}
