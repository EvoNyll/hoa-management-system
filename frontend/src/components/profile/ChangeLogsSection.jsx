  ...
  return (
    <div className="p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Profile Activity Log</h3>
      </div>

      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
        <div className="flex items-center gap-2 mb-2">
          <Clock className="w-4 h-4 text-blue-600 dark:text-blue-400" />
          <span className="text-sm font-medium text-blue-900 dark:text-blue-200">Activity Tracking</span>
        </div>
        ...
        <div className="space-y-4">
          {profileData.changeLogs && profileData.changeLogs.length > 0 ? (
            profileData.changeLogs.map((log, index) => (
              <div key={index} className="flex items-start space-x-4 p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
